...
function buildSummarySheetRows(payload) {
  ...
  return [
    ...
    [createCell("Source Policy"), createCell(payload.selection?.sourcePolicy ?? "")],
    [createCell("Source Name"), createCell(payload.selection?.sourceName ?? "")],
    [createCell("License Note"), createCell(payload.selection?.licenseNote ?? "")],
